                ...
                {config?.easynewsEnabled && config?.easynewsMode === 'nzb' && (
                  <div>
                    ...
                    <p className="text-xs text-amber-400 mt-1 ml-7">
                      ⚠️ With EasyNews enabled and bypassing health checks, this will queue all EasyNews results to NZBDav. In this case, consider "Top Result" to avoid flooding your download client.
                    </p>
                  </div>
                )}
                <div>
